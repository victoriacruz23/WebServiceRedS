            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="mb-3">
                            <label for="formFileSm" class="form-label">Pon una foto:</label>
                        ...
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Unete</button>
                        <p class="text-center mb-0">¿Ya tienes una cuenta? <a href="Sesion.php">Inicia sesion</a></p>
                    </div>
                </div>
            </div>
        </div>
